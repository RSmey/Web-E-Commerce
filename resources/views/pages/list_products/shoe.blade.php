...
<body>
        ...
        <div class="head-web-name-search-basket">
            <table>
                <tr class="search-type">
                    <td><img src="{{asset('logo_images/LogoTop.gif')}}"/></td>
    ...
    <tbody >
        <div class="contain-image-slides" >
            <img class="companySlides" src="{{asset('logo_images/image_slides/slide1.jpg')}}" style="width:100%"/>
            <img class="companySlides" src="{{asset('logo_images/image_slides/slide2.jpg')}}" style="width:100%"/>
            <img class="companySlides" src="{{asset('logo_images/image_slides/slide3.jpg')}}" style="width:100%"/>
            <img class="companySlides" src="{{asset('logo_images/image_slides/slide4.png')}}" style="width:100%"/>
            <img class="companySlides" src="{{asset('logo_images/image_slides/slide5.jpeg')}}" style="width:100%"/>
            <img class="companySlides" src="{{asset('logo_images/image_slides/slide6.jpg')}}" style="width:100%"/>
        </div>
        <script>
            var Index=0;
            slidesShow();
        ...
        <div class="container">
            ...
            <div class="sidebar-main">
                <div class="left-side-bar-contents">
                    @include('pages.sidebar.show_type')
                </div>
            </div>
    ...
    <footer class="footer-container">
        <div class="foot-pro-logo">
            <a><img src="{{asset('logo_images/logo_produce/adidas.jpg')}}"/></a>
            <a><img src="{{asset('logo_images/logo_produce/converse.jpg')}}"/></a>
            <a><img src="{{asset('logo_images/logo_produce/nike.jpg')}}"/></a>
            <a><img src="{{asset('logo_images/logo_produce/puma.jpg')}}"/></a>
            <a><img src="{{asset('logo_images/logo_produce/umbro.jpg')}}"/></a>
            <a><img src="{{asset('logo_images/logo_produce/underArmour.jpg')}}"/></a>
